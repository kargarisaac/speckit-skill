...
1. For each task in the list, use your platform’s GitHub issue creation tool (API/CLI/MCP integration) to create a new issue in the repository that is representative of the Git remote.
